...
import com.degree.cto.repositorys.AdvertisementWorksRepository;
...
public class PersonalPageController {
    ...
    @Autowired
    private AdvertisementWorksRepository advertisementWorksRepository;
    @Autowired
    ...
    public String personalPage(@PathVariable(value = "username") String username, Model model, HttpServletRequest request) {
        try {
            ...
            List<AdvertisementWorksDTO> advertisementWorksDTOList = advertisementWorksRepository.findAll();
            model.addAttribute("advertisementWorksDTOList", advertisementWorksDTOList);
            ...
            model.addAttribute("PageUrl", "/@"+username);
    ...
    @PostMapping("/@{username}")
        public String personalPage(@ModelAttribute("reviewsDTO") ReviewsDTO reviewsDTO, @PathVariable(value = "username") String username, HttpServletRequest request) {
